...
import pandas as pd
from milp4_constrained_total import *
...
kwargs = {'miphint':True, 'mipfocus':1, 'mipgap':0.001, 'presolve':2,
          'logfile':'log_qpsk.log', 'threads':cpus_per_task}
...
n_iter_per_stage = 2 # 10
timelimit_baseline = 60 # 960
timelimit0 = 20 # 60
time_factor = 1.5
...
shutil.copy('milp4_constrained_total.py', simulation_name)
shutil.copy('nsf-24nodes.csv', simulation_name)
shutil.copy('qpsk_TR.csv', simulation_name)
shutil.copy('python_template_qpsk.py', simulation_name)
...
for batch_id in range(num_simulations):
    ...
    # write python files
    python_src = "python_template_qpsk.py"
    seed = np.random.randint(1000000)
    line9 = "from milp4_constrained_total import *\n"
    line10 = "seed = {}\n".format(seed)
    ...
    line24 = "output_file = '{}'\n".format(pickle_file)
    replace_lines = {9:line9, 10:line10, 12:line12, 14:line14, 18:line18, 24:line24}
...
change_file('milp4_constrained_total.py', replace_lines)

for file in os.listdir(os.curdir):
    change_eol_win2unix(file)

os.remove('python_template_qpsk.py')
